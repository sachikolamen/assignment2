---
title: "Parameter Estimation: Lizard Length to Weight"
...
The following section estimates the parameters of a length to weight model for a male Western Whiptail population of lizards. Then a visual comparison of general and species-specific models are shown and RMSE values are calcluated and compared.
```{r}
